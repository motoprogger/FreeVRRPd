...
PROG=		freevrrpd
SRCS=		vrrp_misc.c vrrp_multicast.c vrrp_main.c vrrp_thread.c vrrp_state.c vrrp_network.c vrrp_conf.c vrrp_script.c vrrp_signal.c vrrp_list.c vrrp_vlanlist.c vrrp_moncircuit.c vrrp_ah.c
